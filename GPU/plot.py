...
data = pd.read_csv("particles_gpu.csv", header = None, names=['iter', 'x', 'y', 'z'])
...
ani = FuncAnimation(fig, animate, repeat=True, frames=1000)

ani.save("gpu.gif", writer=PillowWriter(fps=25))